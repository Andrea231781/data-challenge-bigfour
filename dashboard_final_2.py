...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    with t3:
        ...
        with col_b:
            st.dataframe(
                synth_df[["Poste","Note","% Pos","% Nég","Score Rémun.","Score Charge","Score"]]
                .style.background_gradient(subset=["Score"],cmap="RdYlGn")
                .background_gradient(subset=["Score Rémun.","Score Charge"],cmap="RdYlGn")
                .format({"Note":"{:.2f}","% Pos":"{:.1f}%","% Nég":"{:.1f}%",
                         "Score Rémun.":"{:+.1f}","Score Charge":"{:+.1f}","Score":"{:.1f}"}),
